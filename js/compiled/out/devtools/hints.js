...
var map__63725 = top_item;
var map__63725__$1 = ((((!((map__63725 == null)))?((((map__63725.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__63725.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__63725):map__63725);
var file = cljs.core.get.call(null,map__63725__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__63725__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__63725__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e63724){var _e = e63724;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5276__auto___63727 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5276__auto___63727)){
var seen_errors_63728 = temp__5276__auto___63727;
if(cljs.core.truth_(seen_errors_63728.has(self))){
} else {
seen_errors_63728.add(self);

var temp__5278__auto___63729 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5278__auto___63729)){
var sense_63730 = temp__5278__auto___63729;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_63730)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1509280901241
