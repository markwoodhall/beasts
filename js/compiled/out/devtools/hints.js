...
var reader = (function (){var or__49521__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__49521__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__49521__auto__)){
return or__49521__auto__;
} else {
return (128);
...
var map__3264768 = top_item;
var map__3264768__$1 = ((((!((map__3264768 == null)))?((((map__3264768.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__3264768.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__3264768):map__3264768);
var file = cljs.core.get.call(null,map__3264768__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__3264768__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__3264768__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e3264767){var _e = e3264767;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5276__auto___3264770 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5276__auto___3264770)){
var seen_errors_3264771 = temp__5276__auto___3264770;
if(cljs.core.truth_(seen_errors_3264771.has(self))){
} else {
seen_errors_3264771.add(self);

var temp__5278__auto___3264772 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5278__auto___3264772)){
var sense_3264773 = temp__5278__auto___3264772;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_3264773)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1509468963934
