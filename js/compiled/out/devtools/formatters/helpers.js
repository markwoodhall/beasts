...
var G__33902 = devtools.prefs.pref.call(null,v);
v = G__33902;
continue;
} else {
return v;
...
var and__30589__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__30589__auto__){
var and__30589__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
if(and__30589__auto____$1){
...
var or__30601__auto__ = (function (){try{if(!((value == null))){
...
}catch (e33905){var _e__33342__auto__ = e33905;
return false;
}})();
if(cljs.core.truth_(or__30601__auto__)){
return or__30601__auto__;
} else {
var or__30601__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e33909){var _e__33342__auto__ = e33909;
return false;
}})();
...
}catch (e33911){var _e__33342__auto__ = e33911;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__30589__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__30589__auto__)){
var and__30589__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__30589__auto____$1){
...
var and__30589__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__30589__auto__)){
...
var or__30601__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__30601__auto__)){
return or__30601__auto__;
} else {
...
var and__30589__auto__ = (function (){var or__30601__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__30601__auto__)){
return or__30601__auto__;
} else {
...
var vec__33913 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__33913,(0),null);
var name = cljs.core.nth.call(null,vec__33913,(1),null);
...
var and__30589__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__30589__auto__)){
...
var or__30601__auto__ = typeof value === 'string';
if(or__30601__auto__){
return or__30601__auto__;
} else {
var or__30601__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__33916_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__33916_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1509223229906
