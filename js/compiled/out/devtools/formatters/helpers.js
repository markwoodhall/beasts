...
var G__3262973 = devtools.prefs.pref.call(null,v);
v = G__3262973;
continue;
} else {
return v;
...
var and__49509__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__49509__auto__){
var and__49509__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__49521__auto__ = (function (){try{if(!((value == null))){
...
}catch (e3262976){var _e__3262413__auto__ = e3262976;
return false;
}})();
if(cljs.core.truth_(or__49521__auto__)){
return or__49521__auto__;
} else {
var or__49521__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e3262980){var _e__3262413__auto__ = e3262980;
return false;
}})();
...
}catch (e3262982){var _e__3262413__auto__ = e3262982;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__49509__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__49509__auto__)){
var and__49509__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__49509__auto____$1){
...
var and__49509__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__49509__auto__)){
...
var or__49521__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__49521__auto__)){
return or__49521__auto__;
} else {
...
var and__49509__auto__ = (function (){var or__49521__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__49521__auto__)){
return or__49521__auto__;
} else {
...
var vec__3262984 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__3262984,(0),null);
var name = cljs.core.nth.call(null,vec__3262984,(1),null);
...
var and__49509__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__49509__auto__)){
...
var or__49521__auto__ = typeof value === 'string';
if(or__49521__auto__){
return or__49521__auto__;
} else {
var or__49521__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__3262987_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__3262987_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1509468961731
