...
var len__50798__auto___3263002 = arguments.length;
var i__50799__auto___3263003 = (0);
while(true){
if((i__50799__auto___3263003 < len__50798__auto___3263002)){
args__50805__auto__.push((arguments[i__50799__auto___3263003]));

var G__3263004 = (i__50799__auto___3263003 + (1));
i__50799__auto___3263003 = G__3263004;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__50806__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq3262999){
var G__3263000 = cljs.core.first.call(null,seq3262999);
var seq3262999__$1 = cljs.core.next.call(null,seq3262999);
var G__3263001 = cljs.core.first.call(null,seq3262999__$1);
var seq3262999__$2 = cljs.core.next.call(null,seq3262999__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__3263000,G__3263001,seq3262999__$2);
});
...
if(cljs.core.truth_((function (){var or__49521__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__50192__auto__,writer__50193__auto__,opt__50194__auto__){
return cljs.core._write.call(null,writer__50193__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__49509__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__49509__auto__){
var or__49521__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__49521__auto__)){
return or__49521__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__3263005_SHARP_){
return !((cljs.core.meta.call(null,p1__3263005_SHARP_) == null));
})))){
...
var map__3263006 = opts;
var map__3263006__$1 = ((((!((map__3263006 == null)))?((((map__3263006.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__3263006.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__3263006):map__3263006);
var markup_db = cljs.core.get.call(null,map__3263006__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__49521__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e3263010){var _e__3262413__auto__ = e3263010;
return false;
}})();
if(cljs.core.truth_(or__49521__auto__)){
return or__49521__auto__;
...
}catch (e3263012){var _e__3262413__auto__ = e3263012;
return false;
}}
})())){
...
var _STAR_current_state_STAR_3263014 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__3263015 = opts;
var map__3263015__$1 = ((((!((map__3263015 == null)))?((((map__3263015.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__3263015.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__3263015):map__3263015);
var markup_db = cljs.core.get.call(null,map__3263015__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_3263014;
}});
...
;
var temp__5276__auto___3263019 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5276__auto___3263019)){
var managed_print_level_3263020 = temp__5276__auto___3263019;
var _STAR_print_level_STAR_3263018_3263021 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_3263020;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_3263018_3263021,managed_print_level_3263020,temp__5276__auto___3263019,writer,opts,job_fn){
return (function (p1__3263017_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__3263017_SHARP_,null);
});})(_STAR_print_level_STAR_3263018_3263021,managed_print_level_3263020,temp__5276__auto___3263019,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_3263018_3263021;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1509468961840
