...
var o3262871 = temp__5276__auto__;
var temp__5276__auto____$1 = (o3262871["core"]);
if(cljs.core.truth_(temp__5276__auto____$1)){
var o3262872 = temp__5276__auto____$1;
return (o3262872["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__3262406__auto__ = f;
return (o__3262406__auto__["toString"]).call(o__3262406__auto__);
} else {
return "";
}
}catch (e3262873){var _ = e3262873;
return "";
}});
...
try{var o__3262406__auto___3262875 = t;
(o__3262406__auto___3262875["cljs$lang$ctorPrWriter"]).call(o__3262406__auto___3262875,t,writer);
}catch (e3262874){var __3262876 = e3262874;
}
...
var char_code = (function (){var o__3262406__auto__ = (new String(char$));
return (o__3262406__auto__["charCodeAt"]).call(o__3262406__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__3262406__auto__ = String;
return (o__3262406__auto__["fromCharCode"]).call(o__3262406__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__3262877 = num_code;
switch (G__3262877) {
case (1):
return (185);
...
var o__3262406__auto__ = String;
return (o__3262406__auto__["fromCharCode"]).call(o__3262406__auto__,superscript_code);
});
/**
...
}catch (e3262879){var _e__3262413__auto__ = e3262879;
return false;
}})())){
...
var vec__3262880 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__3262880,(0),null);
...
var or__49521__auto__ = (function (){var temp__5276__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5276__auto__)){
...
if(cljs.core.truth_(temp__5276__auto__)){
var o3262883 = temp__5276__auto__;
var temp__5276__auto____$1 = (o3262883["dependencies_"]);
if(cljs.core.truth_(temp__5276__auto____$1)){
var o3262884 = temp__5276__auto____$1;
return (o3262884["nameToPath"]);
} else {
return null;
}
} else {
...
var len__50798__auto___3262891 = arguments.length;
var i__50799__auto___3262892 = (0);
while(true){
if((i__50799__auto___3262892 < len__50798__auto___3262891)){
args__50805__auto__.push((arguments[i__50799__auto___3262892]));

var G__3262893 = (i__50799__auto___3262892 + (1));
i__50799__auto___3262892 = G__3262893;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__50806__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__3262887){
var vec__3262888 = p__3262887;
var ns_detector = cljs.core.nth.call(null,vec__3262888,(0),null);
var effective_detector = (function (){var or__49521__auto__ = ns_detector;
if(cljs.core.truth_(or__49521__auto__)){
return or__49521__auto__;
} else {
...
var G__3262894 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__3262895 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__3262894;
remaining_tokens = G__3262895;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq3262885){
var G__3262886 = cljs.core.first.call(null,seq3262885);
var seq3262885__$1 = cljs.core.next.call(null,seq3262885);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__3262886,seq3262885__$1);
});
...
var vec__3262899 = cljs.core.split_with.call(null,(function (p1__3262898_SHARP_){
return cljs.core.not_EQ_.call(null,p1__3262898_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__3262899,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__3262899,(1),null);
...
var vec__3262902 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__3262902,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__3262902,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__3262905 = cljs.core.rest.call(null,remaining_tokens);
var G__3262906 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__3262905;
name_tokens = G__3262906;
continue;
} else {
...
var G__3262908 = arguments.length;
switch (G__3262908) {
case 1:
...
var vec__3262909 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__3262909,(0),null);
var arity = cljs.core.nth.call(null,vec__3262909,(1),null);
var vec__3262912 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__3262912,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__3262912,(1),null);
var vec__3262915 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__3262915,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__3262915,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__3262915,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__3262915,(3),null);
...
var G__3262920 = arguments.length;
switch (G__3262920) {
case 1:
...
var vec__3262921 = result;
var munged_ns = cljs.core.nth.call(null,vec__3262921,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__3262921,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__3262921,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__3262921,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__3262921,(4),null);
var arity = cljs.core.nth.call(null,vec__3262921,(5),null);
...
if(cljs.core.truth_(temp__5276__auto__)){
var vec__3262925 = temp__5276__auto__;
var munged_name = cljs.core.nth.call(null,vec__3262925,(0),null);
var args = cljs.core.nth.call(null,vec__3262925,(1),null);
var vec__3262928 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__3262928,(0),null);
var name = cljs.core.nth.call(null,vec__3262928,(1),null);
...
var G__3262931 = (arity + (1));
var G__3262932 = (function (){var temp__5276__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5276__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__3262933){
var vec__3262934 = p__3262933;
var arity = cljs.core.nth.call(null,vec__3262934,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__3262934,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__49521__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__49521__auto__)){
return or__49521__auto__;
} else {
...
return (function (p1__3262937_SHARP_){
return cljs.core.get.call(null,arities,p1__3262937_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__3262938_SHARP_){
return cljs.core.drop.call(null,(2),p1__3262938_SHARP_);
...
var args__50805__auto__ = [];
var len__50798__auto___3262945 = arguments.length;
var i__50799__auto___3262946 = (0);
while(true){
if((i__50799__auto___3262946 < len__50798__auto___3262945)){
args__50805__auto__.push((arguments[i__50799__auto___3262946]));

var G__3262947 = (i__50799__auto___3262946 + (1));
i__50799__auto___3262946 = G__3262947;
continue;
} else {
}
break;
...
var argseq__50806__auto__ = ((((1) < args__50805__auto__.length))?(new cljs.core.IndexedSeq(args__50805__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__50806__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__3262941){
var vec__3262942 = p__3262941;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__3262942,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq3262939){
var G__3262940 = cljs.core.first.call(null,seq3262939);
var seq3262939__$1 = cljs.core.next.call(null,seq3262939);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__3262940,seq3262939__$1);
});
...
var G__3262948 = arg;
var G__3262948__$1 = (((G__3262948 instanceof cljs.core.Keyword))?G__3262948.fqn:null);
switch (G__3262948__$1) {
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__49521__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__49521__auto__)){
return or__49521__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__49509__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__49521__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__49521__auto__)){
return or__49521__auto__;
} else {
...
var map__3262950 = options;
var map__3262950__$1 = ((((!((map__3262950 == null)))?((((map__3262950.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__3262950.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__3262950):map__3262950);
var include_ns_QMARK_ = cljs.core.get.call(null,map__3262950__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__3262950__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__3262950__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__3262950__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__3262951 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__3262951,(0),null);
var fn_name = cljs.core.nth.call(null,vec__3262951,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__3262951,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__3262951,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__3262951,(4),null);
var arity = cljs.core.nth.call(null,vec__3262951,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__49509__auto__ = protocol_ns;
if(cljs.core.truth_(and__49509__auto__)){
return cljs.core.not.call(null,(function (){var and__49509__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__49521__auto__ = protocol_part;
if(cljs.core.truth_(or__49521__auto__)){
return or__49521__auto__;
} else {
return fn_part;
...
var o__3262406__auto__ = f;
return (o__3262406__auto__["getBasis"]).call(o__3262406__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__49509__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__49509__auto__)){
...
}catch (e3262955){var _e__3262413__auto__ = e3262955;
...
var G__3262956 = (obj[cljs.core.first.call(null,path)]);
var G__3262957 = cljs.core.rest.call(null,path);
obj = G__3262956;
path = G__3262957;
continue;
} else {
...
var partition_bits = (function (){var or__49521__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__49521__auto__)){
return or__49521__auto__;
} else {
return (0);
...
return (function (accum,p__3262958){
var vec__3262959 = p__3262958;
var bit = cljs.core.nth.call(null,vec__3262959,(0),null);
var protocol = cljs.core.nth.call(null,vec__3262959,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__3262962){
var vec__3262963 = p__3262962;
var ns = cljs.core.nth.call(null,vec__3262963,(0),null);
var name = cljs.core.nth.call(null,vec__3262963,(1),null);
var selector = cljs.core.nth.call(null,vec__3262963,(2),null);
...
return (function (p__3262967){
var vec__3262968 = p__3262967;
var munged_name = cljs.core.nth.call(null,vec__3262968,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__3262968,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__3262968,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__3262966_SHARP_){
return (obj[cljs.core.first.call(null,p1__3262966_SHARP_)]);
});})(name,sorted_matches,vec__3262968,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1509468961664
