...
var o33800 = temp__5276__auto__;
var temp__5276__auto____$1 = (o33800["core"]);
if(cljs.core.truth_(temp__5276__auto____$1)){
var o33801 = temp__5276__auto____$1;
return (o33801["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__33335__auto__ = f;
return (o__33335__auto__["toString"]).call(o__33335__auto__);
} else {
return "";
}
}catch (e33802){var _ = e33802;
return "";
}});
...
try{var o__33335__auto___33804 = t;
(o__33335__auto___33804["cljs$lang$ctorPrWriter"]).call(o__33335__auto___33804,t,writer);
}catch (e33803){var __33805 = e33803;
}
...
var char_code = (function (){var o__33335__auto__ = (new String(char$));
return (o__33335__auto__["charCodeAt"]).call(o__33335__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__33335__auto__ = String;
return (o__33335__auto__["fromCharCode"]).call(o__33335__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__33806 = num_code;
switch (G__33806) {
case (1):
return (185);
...
var o__33335__auto__ = String;
return (o__33335__auto__["fromCharCode"]).call(o__33335__auto__,superscript_code);
});
/**
...
}catch (e33808){var _e__33342__auto__ = e33808;
return false;
}})())){
...
var vec__33809 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__33809,(0),null);
...
var or__30601__auto__ = (function (){var temp__5276__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5276__auto__)){
...
if(cljs.core.truth_(temp__5276__auto__)){
var o33812 = temp__5276__auto__;
var temp__5276__auto____$1 = (o33812["dependencies_"]);
if(cljs.core.truth_(temp__5276__auto____$1)){
var o33813 = temp__5276__auto____$1;
return (o33813["nameToPath"]);
} else {
return null;
}
} else {
...
var len__31878__auto___33820 = arguments.length;
var i__31879__auto___33821 = (0);
while(true){
if((i__31879__auto___33821 < len__31878__auto___33820)){
args__31885__auto__.push((arguments[i__31879__auto___33821]));

var G__33822 = (i__31879__auto___33821 + (1));
i__31879__auto___33821 = G__33822;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31886__auto__);
});
...
var ns_detector = cljs.core.nth.call(null,vec__33817,(0),null);
var effective_detector = (function (){var or__30601__auto__ = ns_detector;
if(cljs.core.truth_(or__30601__auto__)){
return or__30601__auto__;
} else {
...
var G__33823 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__33824 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__33823;
remaining_tokens = G__33824;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq33814){
var G__33815 = cljs.core.first.call(null,seq33814);
var seq33814__$1 = cljs.core.next.call(null,seq33814);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__33815,seq33814__$1);
});
...
var vec__33828 = cljs.core.split_with.call(null,(function (p1__33827_SHARP_){
return cljs.core.not_EQ_.call(null,p1__33827_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__33828,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__33828,(1),null);
...
var vec__33831 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__33831,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__33831,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__33834 = cljs.core.rest.call(null,remaining_tokens);
var G__33835 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
...
var vec__33838 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__33838,(0),null);
var arity = cljs.core.nth.call(null,vec__33838,(1),null);
var vec__33841 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__33841,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__33841,(1),null);
var vec__33844 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__33844,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__33844,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__33844,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__33844,(3),null);
...
var vec__33850 = result;
var munged_ns = cljs.core.nth.call(null,vec__33850,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__33850,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__33850,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__33850,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__33850,(4),null);
...
if(cljs.core.truth_(temp__5276__auto__)){
var vec__33854 = temp__5276__auto__;
var munged_name = cljs.core.nth.call(null,vec__33854,(0),null);
var args = cljs.core.nth.call(null,vec__33854,(1),null);
var vec__33857 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__33857,(0),null);
var name = cljs.core.nth.call(null,vec__33857,(1),null);
...
var G__33860 = (arity + (1));
var G__33861 = (function (){var temp__5276__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5276__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__33862){
var vec__33863 = p__33862;
var arity = cljs.core.nth.call(null,vec__33863,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__33863,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__30601__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__30601__auto__)){
return or__30601__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__33866_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__33867_SHARP_);
...
var args__31885__auto__ = [];
var len__31878__auto___33874 = arguments.length;
var i__31879__auto___33875 = (0);
while(true){
if((i__31879__auto___33875 < len__31878__auto___33874)){
args__31885__auto__.push((arguments[i__31879__auto___33875]));

var G__33876 = (i__31879__auto___33875 + (1));
i__31879__auto___33875 = G__33876;
continue;
} else {
}
break;
...
var argseq__31886__auto__ = ((((1) < args__31885__auto__.length))?(new cljs.core.IndexedSeq(args__31885__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31886__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__33870){
var vec__33871 = p__33870;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__33871,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq33868){
var G__33869 = cljs.core.first.call(null,seq33868);
var seq33868__$1 = cljs.core.next.call(null,seq33868);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__33869,seq33868__$1);
});
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__30601__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__30601__auto__)){
return or__30601__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__30589__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__30601__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__30601__auto__)){
return or__30601__auto__;
} else {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__33879__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__33879__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__33879__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__33879__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__33880 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__33880,(0),null);
var fn_name = cljs.core.nth.call(null,vec__33880,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__33880,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__33880,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__33880,(4),null);
var arity = cljs.core.nth.call(null,vec__33880,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__30589__auto__ = protocol_ns;
if(cljs.core.truth_(and__30589__auto__)){
return cljs.core.not.call(null,(function (){var and__30589__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__30601__auto__ = protocol_part;
if(cljs.core.truth_(or__30601__auto__)){
return or__30601__auto__;
} else {
return fn_part;
...
var o__33335__auto__ = f;
return (o__33335__auto__["getBasis"]).call(o__33335__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__30589__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__30589__auto__)){
...
}catch (e33884){var _e__33342__auto__ = e33884;
...
var G__33885 = (obj[cljs.core.first.call(null,path)]);
var G__33886 = cljs.core.rest.call(null,path);
obj = G__33885;
path = G__33886;
continue;
} else {
...
var partition_bits = (function (){var or__30601__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__30601__auto__)){
return or__30601__auto__;
} else {
return (0);
...
return (function (accum,p__33887){
var vec__33888 = p__33887;
var bit = cljs.core.nth.call(null,vec__33888,(0),null);
var protocol = cljs.core.nth.call(null,vec__33888,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__33891){
var vec__33892 = p__33891;
var ns = cljs.core.nth.call(null,vec__33892,(0),null);
var name = cljs.core.nth.call(null,vec__33892,(1),null);
var selector = cljs.core.nth.call(null,vec__33892,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__33897,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__33897,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__33897,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__33895_SHARP_){
return (obj[cljs.core.first.call(null,p1__33895_SHARP_)]);
});})(name,sorted_matches,vec__33897,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1509223229795
