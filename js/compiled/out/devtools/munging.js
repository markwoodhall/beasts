...
var o61827 = temp__5276__auto__;
var temp__5276__auto____$1 = (o61827["core"]);
if(cljs.core.truth_(temp__5276__auto____$1)){
var o61828 = temp__5276__auto____$1;
return (o61828["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__61362__auto__ = f;
return (o__61362__auto__["toString"]).call(o__61362__auto__);
} else {
return "";
}
}catch (e61829){var _ = e61829;
return "";
}});
...
try{var o__61362__auto___61831 = t;
(o__61362__auto___61831["cljs$lang$ctorPrWriter"]).call(o__61362__auto___61831,t,writer);
}catch (e61830){var __61832 = e61830;
}
...
var char_code = (function (){var o__61362__auto__ = (new String(char$));
return (o__61362__auto__["charCodeAt"]).call(o__61362__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__61362__auto__ = String;
return (o__61362__auto__["fromCharCode"]).call(o__61362__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__61833 = num_code;
switch (G__61833) {
case (1):
return (185);
...
var o__61362__auto__ = String;
return (o__61362__auto__["fromCharCode"]).call(o__61362__auto__,superscript_code);
});
/**
...
}catch (e61835){var _e__61369__auto__ = e61835;
return false;
}})())){
...
var vec__61836 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__61836,(0),null);
...
if(cljs.core.truth_(temp__5276__auto__)){
var o61839 = temp__5276__auto__;
var temp__5276__auto____$1 = (o61839["dependencies_"]);
if(cljs.core.truth_(temp__5276__auto____$1)){
var o61840 = temp__5276__auto____$1;
return (o61840["nameToPath"]);
} else {
return null;
}
} else {
...
var len__50798__auto___61847 = arguments.length;
var i__50799__auto___61848 = (0);
while(true){
if((i__50799__auto___61848 < len__50798__auto___61847)){
args__50805__auto__.push((arguments[i__50799__auto___61848]));

var G__61849 = (i__50799__auto___61848 + (1));
i__50799__auto___61848 = G__61849;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__61843){
var vec__61844 = p__61843;
var ns_detector = cljs.core.nth.call(null,vec__61844,(0),null);
...
var G__61850 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__61851 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__61850;
remaining_tokens = G__61851;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq61841){
var G__61842 = cljs.core.first.call(null,seq61841);
var seq61841__$1 = cljs.core.next.call(null,seq61841);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__61842,seq61841__$1);
});
...
var vec__61855 = cljs.core.split_with.call(null,(function (p1__61854_SHARP_){
return cljs.core.not_EQ_.call(null,p1__61854_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__61855,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__61855,(1),null);
...
var vec__61858 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__61858,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__61858,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__61861 = cljs.core.rest.call(null,remaining_tokens);
var G__61862 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__61861;
name_tokens = G__61862;
continue;
} else {
...
var vec__61865 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__61865,(0),null);
var arity = cljs.core.nth.call(null,vec__61865,(1),null);
var vec__61868 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__61868,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__61868,(1),null);
var vec__61871 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__61871,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__61871,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__61871,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__61871,(3),null);
...
var vec__61877 = result;
var munged_ns = cljs.core.nth.call(null,vec__61877,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__61877,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__61877,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__61877,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__61877,(4),null);
var arity = cljs.core.nth.call(null,vec__61877,(5),null);
...
if(cljs.core.truth_(temp__5276__auto__)){
var vec__61881 = temp__5276__auto__;
var munged_name = cljs.core.nth.call(null,vec__61881,(0),null);
var args = cljs.core.nth.call(null,vec__61881,(1),null);
var vec__61884 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__61884,(0),null);
var name = cljs.core.nth.call(null,vec__61884,(1),null);
...
var G__61887 = (arity + (1));
var G__61888 = (function (){var temp__5276__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5276__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__61889){
var vec__61890 = p__61889;
var arity = cljs.core.nth.call(null,vec__61890,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__61890,(1),null);
...
return cljs.core.get.call(null,arities,p1__61893_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__61894_SHARP_);
...
var args__50805__auto__ = [];
var len__50798__auto___61901 = arguments.length;
var i__50799__auto___61902 = (0);
while(true){
if((i__50799__auto___61902 < len__50798__auto___61901)){
args__50805__auto__.push((arguments[i__50799__auto___61902]));

var G__61903 = (i__50799__auto___61902 + (1));
i__50799__auto___61902 = G__61903;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__61897){
var vec__61898 = p__61897;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__61898,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq61895){
var G__61896 = cljs.core.first.call(null,seq61895);
var seq61895__$1 = cljs.core.next.call(null,seq61895);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__61896,seq61895__$1);
});
...
var G__61904 = arg;
var G__61904__$1 = (((G__61904 instanceof cljs.core.Keyword))?G__61904.fqn:null);
switch (G__61904__$1) {
...
var map__61906 = options;
var map__61906__$1 = ((((!((map__61906 == null)))?((((map__61906.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__61906.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__61906):map__61906);
var include_ns_QMARK_ = cljs.core.get.call(null,map__61906__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__61906__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__61906__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__61906__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__61907 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__61907,(0),null);
var fn_name = cljs.core.nth.call(null,vec__61907,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__61907,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__61907,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__61907,(4),null);
var arity = cljs.core.nth.call(null,vec__61907,(5),null);
...
var o__61362__auto__ = f;
return (o__61362__auto__["getBasis"]).call(o__61362__auto__);
});
/**
...
}catch (e61911){var _e__61369__auto__ = e61911;
...
var G__61912 = (obj[cljs.core.first.call(null,path)]);
var G__61913 = cljs.core.rest.call(null,path);
obj = G__61912;
path = G__61913;
continue;
} else {
...
return (function (accum,p__61914){
var vec__61915 = p__61914;
var bit = cljs.core.nth.call(null,vec__61915,(0),null);
var protocol = cljs.core.nth.call(null,vec__61915,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__61918){
var vec__61919 = p__61918;
var ns = cljs.core.nth.call(null,vec__61919,(0),null);
var name = cljs.core.nth.call(null,vec__61919,(1),null);
var selector = cljs.core.nth.call(null,vec__61919,(2),null);
...
return (function (p__61923){
var vec__61924 = p__61923;
var munged_name = cljs.core.nth.call(null,vec__61924,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__61924,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__61924,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__61922_SHARP_){
return (obj[cljs.core.first.call(null,p1__61922_SHARP_)]);
});})(name,sorted_matches,vec__61924,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1509280899125
