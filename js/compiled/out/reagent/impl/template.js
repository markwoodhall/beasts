...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__50192__auto__,writer__50193__auto__,opt__50194__auto__){
return cljs.core._write.call(null,writer__50193__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__3256540 = o;
(G__3256540[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__3256541__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__3256541 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__3256542__i = 0, G__3256542__a = new Array(arguments.length -  0);
while (G__3256542__i < G__3256542__a.length) {G__3256542__a[G__3256542__i] = arguments[G__3256542__i + 0]; ++G__3256542__i;}
  args = new cljs.core.IndexedSeq(G__3256542__a,0,null);
} 
return G__3256541__delegate.call(this,args);};
G__3256541.cljs$lang$maxFixedArity = 0;
G__3256541.cljs$lang$applyTo = (function (arglist__3256543){
var args = cljs.core.seq(arglist__3256543);
return G__3256541__delegate(args);
});
G__3256541.cljs$core$IFn$_invoke$arity$variadic = G__3256541__delegate;
return G__3256541;
})()
;
} else {
...
if(cljs.core.truth_((function (){var and__49509__auto__ = !((jsprops == null));
if(and__49509__auto__){
var and__49509__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__3256546 = jsprops;
(G__3256546["defaultValue"] = value);

(G__3256546["onChange"] = ((function (G__3256546,v,value,on_change){
return (function (p1__3256545_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__3256545_SHARP_);
});})(G__3256546,v,value,on_change))
);
...
var vec__3256549 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__3256549,(0),null);
var id = cljs.core.nth.call(null,vec__3256549,(1),null);
var class$ = cljs.core.nth.call(null,vec__3256549,(2),null);
...
var jsprops = ({"argv": v});
var temp__5282__auto___3256553 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5282__auto___3256553 == null)){
} else {
var key_3256554 = temp__5282__auto___3256553;
(jsprops["key"] = key_3256554);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__3256555 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__3256555["name"] = c);

(G__3256555["id"] = null);

(G__3256555["class"] = null);
...
var len__50798__auto___3256560 = arguments.length;
var i__50799__auto___3256561 = (0);
while(true){
if((i__50799__auto___3256561 < len__50798__auto___3256560)){
args__50805__auto__.push((arguments[i__50799__auto___3256561]));

var G__3256562 = (i__50799__auto___3256561 + (1));
i__50799__auto___3256561 = G__3256562;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__50806__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq3256558){
var G__3256559 = cljs.core.first.call(null,seq3256558);
var seq3256558__$1 = cljs.core.next.call(null,seq3256558);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__3256559,seq3256558__$1);
});
...
break;
default:
var G__3256565 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__3256565;
continue;
...
var n__50564__auto___3256567 = a.length;
var i_3256568 = (0);
while(true){
if((i_3256568 < n__50564__auto___3256567)){
(a[i_3256568] = reagent.impl.template.as_element.call(null,(a[i_3256568])));

var G__3256569 = (i_3256568 + (1));
i_3256568 = G__3256569;
continue;
} else {
}
break;
...
var a = cljs.core.into_array.call(null,s);
var n__50564__auto___3256570 = a.length;
var i_3256571 = (0);
while(true){
if((i_3256571 < n__50564__auto___3256570)){
var val_3256572 = (a[i_3256571]);
if((cljs.core.vector_QMARK_.call(null,val_3256572)) && ((reagent.impl.template.key_from_vec.call(null,val_3256572) == null))){
(o["no-key"] = true);
} else {
}

(a[i_3256571] = reagent.impl.template.as_element.call(null,val_3256572));

var G__3256573 = (i_3256571 + (1));
i_3256571 = G__3256573;
continue;
} else {
}
break;
...
var ctx = ({});
var vec__3256574 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__3256574,(0),null);
var derefed = cljs.core.nth.call(null,vec__3256574,(1),null);
...
var G__3256577 = (cljs.core.count.call(null,argv) - first_child);
switch (G__3256577) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__3256577){
...
//# sourceMappingURL=template.js.map?rel=1509468956477
