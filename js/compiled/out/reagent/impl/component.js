...
if((i < len)){
var k = (ks[i]);
var G__3256500 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__3256501 = (i + (1));
m = G__3256500;
i = G__3256501;
continue;
...
return (cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__3256503 = c;
var G__3256503__$1 = (((G__3256503 == null))?null:G__3256503.prototype);
if((G__3256503__$1 == null)){
return null;
} else {
return (G__3256503__$1["reagentRender"]);
}
})() == null)));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__3256505 = c;
var G__3256505__$1 = (((G__3256505 == null))?null:G__3256505.prototype);
if((G__3256505__$1 == null)){
return null;
} else {
return (G__3256505__$1["render"]);
}
})() == null)));
});
...
return (function() { 
var G__3256508__delegate = function (args){
return reagent.impl.component.as_element.call(null,cljs.core.apply.call(null,cljs.core.vector,res,args));
};
var G__3256508 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__3256509__i = 0, G__3256509__a = new Array(arguments.length -  0);
while (G__3256509__i < G__3256509__a.length) {G__3256509__a[G__3256509__i] = arguments[G__3256509__i + 0]; ++G__3256509__i;}
  args = new cljs.core.IndexedSeq(G__3256509__a,0,null);
} 
return G__3256508__delegate.call(this,args);};
G__3256508.cljs$lang$maxFixedArity = 0;
G__3256508.cljs$lang$applyTo = (function (arglist__3256510){
var args = cljs.core.seq(arglist__3256510);
return G__3256508__delegate(args);
});
G__3256508.cljs$core$IFn$_invoke$arity$variadic = G__3256508__delegate;
return G__3256508;
})()
;})(c,f,_,res))
:res);
...
var _STAR_current_component_STAR_3256512 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_3256512;
}});
...
var G__3256513 = key;
var G__3256513__$1 = (((G__3256513 instanceof cljs.core.Keyword))?G__3256513.fqn:null);
switch (G__3256513__$1) {
case "getDefaultProps":
throw (new Error("getDefaultProps not supported"));

break;
case "getInitialState":
return ((function (G__3256513,G__3256513__$1){
...
var or__49521__auto__ = reagent.impl.util._STAR_always_update_STAR_;
...
var c = this;
var G__3256514_3256516 = (c["cljsRatom"]);
if((G__3256514_3256516 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__3256514_3256516);
}
...
if(cljs.core.truth_((function (){var and__49509__auto__ = wrap;
...
var renders_3256518 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_3256519 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_3256518));
if((cljs.core.count.call(null,renders_3256518) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_3256518))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_3256519)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,render_fun_3256519))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}


var render_fun = (function (){var or__49521__auto__ = new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__49521__auto__)){
return or__49521__auto__;
} else {
...
var render_fun__$1 = (function (){var or__49521__auto__ = render_fun;
if(cljs.core.truth_(or__49521__auto__)){
return or__49521__auto__;
} else {
...
var name = [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__49521__auto__ = new cljs.core.Keyword(null,"displayName","displayName",-809144601).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__49521__auto__)){
return or__49521__auto__;
} else {
...
var name__$1 = (function (){var G__3256517 = name;
switch (G__3256517) {
case "":
...
var G__3256521 = o;
(G__3256521[cljs.core.name.call(null,k)] = v);
...
var elem = (function (){var G__3256522 = (function (){var or__49521__auto__ = (function (){var G__3256524 = c;
if((G__3256524 == null)){
return null;
} else {
return (G__3256524["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__49521__auto__)){
return or__49521__auto__;
...
return (G__3256522["_currentElement"]);
}
})();
var name = (function (){var G__3256525 = elem;
var G__3256525__$1 = (((G__3256525 == null))?null:(G__3256525["type"]));
if((G__3256525__$1 == null)){
return null;
} else {
return (G__3256525__$1["displayName"]);
}
})();
var path = (function (){var G__3256526 = elem;
var G__3256526__$1 = (((G__3256526 == null))?null:(G__3256526["_owner"]));
var G__3256526__$2 = (((G__3256526__$1 == null))?null:reagent.impl.component.component_path.call(null,G__3256526__$1));
if((G__3256526__$2 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__3256526__$2)," > "].join('');
}
})();
...
var n = (function (){var or__49521__auto__ = reagent.impl.component.component_path.call(null,c);
if(cljs.core.truth_(or__49521__auto__)){
return or__49521__auto__;
} else {
var G__3256527 = c;
var G__3256527__$1 = (((G__3256527 == null))?null:G__3256527.constructor);
if((G__3256527__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__3256527__$1);
}
}
})();
...
//# sourceMappingURL=component.js.map?rel=1509468956363
