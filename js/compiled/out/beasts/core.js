...
return cljs.core.map.call(null,(function (p1__269489_SHARP_){
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"beast-name","beast-name",-1258991623).cljs$core$IFn$_invoke$arity$1(p1__269489_SHARP_),id)){
return cljs.core.update.call(null,p1__269489_SHARP_,new cljs.core.Keyword(null,"card-visible?","card-visible?",1523955713),cljs.core.not);
} else {
return p1__269489_SHARP_;
}
}),beasts__$1);
});
...
return (function (p1__269536_SHARP_){
return cljs.core.assoc.call(null,p1__269536_SHARP_,new cljs.core.Keyword(null,"visible?","visible?",2129863715),clojure.string.includes_QMARK_.call(null,clojure.string.lower_case.call(null,cljs.core.name.call(null,new cljs.core.Keyword(null,"beast-name","beast-name",-1258991623).cljs$core$IFn$_invoke$arity$1(p1__269536_SHARP_))),search_lower));
});})(search_lower))
,beasts__$1);
});
beasts.core.filter_beasts = (function beasts$core$filter_beasts(filters,filter_key,beasts__$1){
return cljs.core.map.call(null,(function (p1__269621_SHARP_){
return cljs.core.assoc.call(null,p1__269621_SHARP_,new cljs.core.Keyword(null,"visible?","visible?",2129863715),cljs.core.some.call(null,cljs.core.PersistentHashSet.createAsIfByAssoc([filter_key.call(null,p1__269621_SHARP_)]),filters));
}),beasts__$1);
});
...
beasts.core.beast_title = (function beasts$core$beast_title(p__269781){
var map__269785 = p__269781;
var map__269785__$1 = ((((!((map__269785 == null)))?((((map__269785.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__269785.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__269785):map__269785);
var beast_name = cljs.core.get.call(null,map__269785__$1,new cljs.core.Keyword(null,"beast-name","beast-name",-1258991623));
var allegiance = cljs.core.get.call(null,map__269785__$1,new cljs.core.Keyword(null,"allegiance","allegiance",918520231));
...
beasts.core.front_beast_view = (function beasts$core$front_beast_view(p__269966){
var map__269970 = p__269966;
var map__269970__$1 = ((((!((map__269970 == null)))?((((map__269970.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__269970.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__269970):map__269970);
var card_visible_QMARK_ = cljs.core.get.call(null,map__269970__$1,new cljs.core.Keyword(null,"card-visible?","card-visible?",1523955713));
var image = cljs.core.get.call(null,map__269970__$1,new cljs.core.Keyword(null,"image","image",-58725096));
var beast_name = cljs.core.get.call(null,map__269970__$1,new cljs.core.Keyword(null,"beast-name","beast-name",-1258991623));
...
beasts.core.visible_beast_view = (function beasts$core$visible_beast_view(p__270123){
var map__270130 = p__270123;
var map__270130__$1 = ((((!((map__270130 == null)))?((((map__270130.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__270130.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__270130):map__270130);
var beast = map__270130__$1;
var card_visible_QMARK_ = cljs.core.get.call(null,map__270130__$1,new cljs.core.Keyword(null,"card-visible?","card-visible?",1523955713));
var beast_name = cljs.core.get.call(null,map__270130__$1,new cljs.core.Keyword(null,"beast-name","beast-name",-1258991623));
var power = cljs.core.get.call(null,map__270130__$1,new cljs.core.Keyword(null,"power","power",-937852079));
var age = cljs.core.get.call(null,map__270130__$1,new cljs.core.Keyword(null,"age","age",-604307804));
var size = cljs.core.get.call(null,map__270130__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var magic_level = cljs.core.get.call(null,map__270130__$1,new cljs.core.Keyword(null,"magic-level","magic-level",1970728713));
var fright_factor = cljs.core.get.call(null,map__270130__$1,new cljs.core.Keyword(null,"fright-factor","fright-factor",-1727457491));
...
beasts.core.render_beast = (function beasts$core$render_beast(app,p__270558){
var map__270564 = p__270558;
var map__270564__$1 = ((((!((map__270564 == null)))?((((map__270564.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__270564.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__270564):map__270564);
var beast = map__270564__$1;
var beast_name = cljs.core.get.call(null,map__270564__$1,new cljs.core.Keyword(null,"beast-name","beast-name",-1258991623));
var visible_QMARK_ = cljs.core.get.call(null,map__270564__$1,new cljs.core.Keyword(null,"visible?","visible?",2129863715));
var card_visible_QMARK_ = cljs.core.get.call(null,map__270564__$1,new cljs.core.Keyword(null,"card-visible?","card-visible?",1523955713));
...
var map__271118 = cljs.core.deref.call(null,app);
var map__271118__$1 = ((((!((map__271118 == null)))?((((map__271118.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__271118.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__271118):map__271118);
var title = cljs.core.get.call(null,map__271118__$1,new cljs.core.Keyword(null,"title","title",636505583));
var beasts__$1 = cljs.core.get.call(null,map__271118__$1,new cljs.core.Keyword(null,"beasts","beasts",-846459732));
...
//# sourceMappingURL=core.js.map?rel=1509266015991
