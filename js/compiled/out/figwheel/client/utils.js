...
var or__49521__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj3259693 = {"detail":data};
return obj3259693;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__49509__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__49509__auto__)){
var and__49509__auto____$1 = goog.object.get(window,"CustomEvent");
...
var G__3259699 = arguments.length;
switch (G__3259699) {
case 1:
...
var f = (function (){var pred__3259700 = cljs.core._EQ_;
var expr__3259701 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__3259700.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__3259701))){
return ((function (pred__3259700,expr__3259701){
return (function (p1__3259694_SHARP_){
return console.warn(p1__3259694_SHARP_);
});
;})(pred__3259700,expr__3259701))
} else {
if(cljs.core.truth_(pred__3259700.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__3259701))){
return ((function (pred__3259700,expr__3259701){
return (function (p1__3259695_SHARP_){
return console.debug(p1__3259695_SHARP_);
});
;})(pred__3259700,expr__3259701))
} else {
if(cljs.core.truth_(pred__3259700.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__3259701))){
return ((function (pred__3259700,expr__3259701){
return (function (p1__3259696_SHARP_){
return console.error(p1__3259696_SHARP_);
});
;})(pred__3259700,expr__3259701))
} else {
return ((function (pred__3259700,expr__3259701){
return (function (p1__3259697_SHARP_){
return console.log(p1__3259697_SHARP_);
});
;})(pred__3259700,expr__3259701))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__3259704){
var map__3259705 = p__3259704;
var map__3259705__$1 = ((((!((map__3259705 == null)))?((((map__3259705.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__3259705.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__3259705):map__3259705);
var opts = map__3259705__$1;
var eval_fn = cljs.core.get.call(null,map__3259705__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__3259707_SHARP_){
return new_def.callback(p1__3259707_SHARP_);
});})(new_def))
);
...
return (function (p__3259708){
var vec__3259709 = p__3259708;
var ky = cljs.core.nth.call(null,vec__3259709,(0),null);
var v = cljs.core.nth.call(null,vec__3259709,(1),null);
...
var G__3259713 = arguments.length;
switch (G__3259713) {
case 2:
...
if(cljs.core.truth_((function (){var and__49509__auto__ = typeof localStorage !== 'undefined';
...
}catch (e3259714){if((e3259714 instanceof Error)){
var e = e3259714;
return not_found;
} else {
throw e3259714;
...
//# sourceMappingURL=utils.js.map?rel=1509468958929
