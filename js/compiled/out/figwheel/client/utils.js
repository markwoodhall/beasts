...
return (new CustomEvent(event_name,(function (){var obj150295 = {"detail":data};
return obj150295;
})()));
} else {
...
var G__150301 = arguments.length;
switch (G__150301) {
case 1:
...
var f = (function (){var pred__150302 = cljs.core._EQ_;
var expr__150303 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__150302.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__150303))){
return ((function (pred__150302,expr__150303){
return (function (p1__150296_SHARP_){
return console.warn(p1__150296_SHARP_);
});
;})(pred__150302,expr__150303))
} else {
if(cljs.core.truth_(pred__150302.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__150303))){
return ((function (pred__150302,expr__150303){
return (function (p1__150297_SHARP_){
return console.debug(p1__150297_SHARP_);
});
;})(pred__150302,expr__150303))
} else {
if(cljs.core.truth_(pred__150302.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__150303))){
return ((function (pred__150302,expr__150303){
return (function (p1__150298_SHARP_){
return console.error(p1__150298_SHARP_);
});
;})(pred__150302,expr__150303))
} else {
return ((function (pred__150302,expr__150303){
return (function (p1__150299_SHARP_){
return console.log(p1__150299_SHARP_);
});
;})(pred__150302,expr__150303))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__150306){
var map__150307 = p__150306;
var map__150307__$1 = ((((!((map__150307 == null)))?((((map__150307.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__150307.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__150307):map__150307);
var opts = map__150307__$1;
var eval_fn = cljs.core.get.call(null,map__150307__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__150309_SHARP_){
return new_def.callback(p1__150309_SHARP_);
});})(new_def))
);
...
return (function (p__150310){
var vec__150311 = p__150310;
var ky = cljs.core.nth.call(null,vec__150311,(0),null);
var v = cljs.core.nth.call(null,vec__150311,(1),null);
...
var G__150315 = arguments.length;
switch (G__150315) {
case 2:
...
}catch (e150316){if((e150316 instanceof Error)){
var e = e150316;
return not_found;
} else {
throw e150316;
...
//# sourceMappingURL=utils.js.map?rel=1509265455395
