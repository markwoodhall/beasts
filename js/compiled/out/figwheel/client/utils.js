...
return (new CustomEvent(event_name,(function (){var obj58617 = {"detail":data};
return obj58617;
})()));
} else {
...
var f = (function (){var pred__58624 = cljs.core._EQ_;
var expr__58625 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__58624.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__58625))){
return ((function (pred__58624,expr__58625){
return (function (p1__58618_SHARP_){
return console.warn(p1__58618_SHARP_);
});
;})(pred__58624,expr__58625))
} else {
if(cljs.core.truth_(pred__58624.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__58625))){
return ((function (pred__58624,expr__58625){
return (function (p1__58619_SHARP_){
return console.debug(p1__58619_SHARP_);
});
;})(pred__58624,expr__58625))
} else {
if(cljs.core.truth_(pred__58624.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__58625))){
return ((function (pred__58624,expr__58625){
return (function (p1__58620_SHARP_){
return console.error(p1__58620_SHARP_);
});
;})(pred__58624,expr__58625))
} else {
return ((function (pred__58624,expr__58625){
return (function (p1__58621_SHARP_){
return console.log(p1__58621_SHARP_);
});
;})(pred__58624,expr__58625))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__58628){
var map__58629 = p__58628;
var map__58629__$1 = ((((!((map__58629 == null)))?((((map__58629.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__58629.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__58629):map__58629);
var opts = map__58629__$1;
var eval_fn = cljs.core.get.call(null,map__58629__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__58631_SHARP_){
return new_def.callback(p1__58631_SHARP_);
});})(new_def))
);
...
return (function (p__58632){
var vec__58633 = p__58632;
var ky = cljs.core.nth.call(null,vec__58633,(0),null);
var v = cljs.core.nth.call(null,vec__58633,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1509280896818
