...
var len__31878__auto___33931 = arguments.length;
var i__31879__auto___33932 = (0);
while(true){
if((i__31879__auto___33932 < len__31878__auto___33931)){
args__31885__auto__.push((arguments[i__31879__auto___33932]));

var G__33933 = (i__31879__auto___33932 + (1));
i__31879__auto___33932 = G__33933;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__31886__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq33928){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__33929,G__33930,seq33928__$2);
});
...
if(cljs.core.truth_((function (){var or__30601__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__31272__auto__,writer__31273__auto__,opt__31274__auto__){
return cljs.core._write.call(null,writer__31273__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__30589__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__30589__auto__){
var or__30601__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__30601__auto__)){
return or__30601__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__33934_SHARP_){
return !((cljs.core.meta.call(null,p1__33934_SHARP_) == null));
})))){
...
var map__33935 = opts;
var map__33935__$1 = ((((!((map__33935 == null)))?((((map__33935.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__33935.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__33935):map__33935);
var markup_db = cljs.core.get.call(null,map__33935__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__30601__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e33939){var _e__33342__auto__ = e33939;
return false;
}})();
if(cljs.core.truth_(or__30601__auto__)){
return or__30601__auto__;
...
}catch (e33941){var _e__33342__auto__ = e33941;
return false;
}}
})())){
...
var _STAR_current_state_STAR_33943 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__33944 = opts;
var map__33944__$1 = ((((!((map__33944 == null)))?((((map__33944.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__33944.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__33944):map__33944);
var markup_db = cljs.core.get.call(null,map__33944__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_33943;
}});
...
;
var temp__5276__auto___33948 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5276__auto___33948)){
var managed_print_level_33949 = temp__5276__auto___33948;
var _STAR_print_level_STAR_33947_33950 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_33949;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_33947_33950,managed_print_level_33949,temp__5276__auto___33948,writer,opts,job_fn){
return (function (p1__33946_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__33946_SHARP_,null);
});})(_STAR_print_level_STAR_33947_33950,managed_print_level_33949,temp__5276__auto___33948,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_33947_33950;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1509220038011
